...
if(isset($_POST["Submit"])){
		...
		$sql="DELETE FROM emp_record WHERE id='$SearchQueryParametar'";
	...
	/*	$stmt->bindValue('eName',$EName);
		...
		if($Execute){
            echo "aaaaaaaaaaaaaa";
			echo '<script>window.open("View_From_DB.php?id=Record Deleted Successfully","_self")</script>';
		}
...
?>
<div>
	<form class="" action="Delete.php?id=<?php echo $SearchQueryParametar; ?>" method="post">
		<fieldset>
